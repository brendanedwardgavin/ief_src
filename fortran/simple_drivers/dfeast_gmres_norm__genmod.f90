        ...
        MODULE DFEAST_GMRES_NORM__genmod
          INTERFACE 
            SUBROUTINE DFEAST_GMRES_NORM(IJOB,STATEVARS,BRHS,X,V,AV,AX, &
     &ZE,N,M,RESTARTS,M0,XWORK,WORKIN,AV2)
              INTEGER(KIND=4) :: N
              INTEGER(KIND=4) :: IJOB
          ...
          END INTERFACE 
        END MODULE DFEAST_GMRES_NORM__genmod
