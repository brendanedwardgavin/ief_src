        ...
        MODULE ZFEAST_GMRESPRE__genmod
          INTERFACE 
            SUBROUTINE ZFEAST_GMRESPRE(IJOB,STATEVARS,BRHS,X,V,AV,AX,ZE,&
     &N,M,MAXM,EPS,RESTARTS,M0,XWORK,WORKIN,AV2,TIMES)
              INTEGER(KIND=4) :: M
              INTEGER(KIND=4) :: N
              INTEGER(KIND=4) :: IJOB
          ...
          END INTERFACE 
        END MODULE ZFEAST_GMRESPRE__genmod
