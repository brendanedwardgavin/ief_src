...
complex (kind=kind(0.0d0)),dimension(:,:),allocatable :: Az
complex (kind=kind(0.0d0)), dimension(:,:), allocatable :: preout,xpre !preconditioner output
...
allocate(preout(n,m0),Az(n,n),xpre(n,m0))
        ...
        case (11) !solve linear system Az*Qz=zwork for Qz, put Qz in zwork 
            ...
            do while (linState(1) .ne. 0)
                ...
                if(linjob == 30) then
                   ...
                   if(loop>0) then                    
                        call pre_dmult(n,m0,Az,xpre,linwork1,preout,ze2)
                        !preout=linwork1
                        call zgemm('N','N',n,m0,n,(1.0d0,0.0d0),A,n,preout,n,(0.0d0,0.0d0),linwork2,n)                   
                    else
                        call zgemm('N','N',n,m0,n,(1.0d0,0.0d0),A,n,linwork1,n,(0.0d0,0.0d0),linwork2,n)
                    end if 
                ...
                if(linjob == 40) then
                    if(loop>0) then
                        call pre_dmult(n,m0,Az,xpre,linwork1,linwork2,ze2)
                    else
                        linwork2=linwork1
                    end if                 
                end if
            ...
            call pre_dmult(n,m0,Az,xpre,zwork,preout,ze2)
            zwork=preout
        ...
        case(21)
            ...
            do while (linState(1) .ne. 0)
                ...
                if(linjob == 30) then
                    ...
                    call system_clock(count=c1)
                    if(loop>0) then                    
                        call pre_dmult(n,m0,Az,xpre,linwork1,preout,conjg(ze2))
                        !preout=linwork1
                        call zgemm('N','N',n,m0,n,(1.0d0,0.0d0),A,n,preout,n,(0.0d0,0.0d0),linwork2,n)                   
                    else
                        call zgemm('N','N',n,m0,n,(1.0d0,0.0d0),A,n,linwork1,n,(0.0d0,0.0d0),linwork2,n)
                ...
                if(linjob == 40) then
                    if(loop>0) then
                        call pre_dmult(n,m0,Az,xpre,linwork1,linwork2,conjg(ze2))
                    else
                        linwork2=linwork1
                    end if
                end if
            ...
            call pre_dmult(n,m0,Az,xpre,zwork,preout,conjg(ze2))
            zwork=preout
